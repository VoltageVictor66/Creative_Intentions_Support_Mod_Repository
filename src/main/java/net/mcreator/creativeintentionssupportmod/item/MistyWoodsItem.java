...
public class MistyWoodsItem extends Item {
	public MistyWoodsItem() {
		super(new Item.Properties().tab(CreativeIntentionsSupportModModTabs.TAB_CREATIVE_INTENTIONS_TAB).durability(64));
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				MistyWoodsPortalBlock.portalSpawn(world, pos);
