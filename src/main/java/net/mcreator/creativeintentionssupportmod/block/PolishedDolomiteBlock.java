...
public class PolishedDolomiteBlock extends Block {
	public PolishedDolomiteBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(CreativeIntentionsSupportModModBlocks.COBBLED_DOLOMITE.get()));
	}
}
