...
package net.mcreator.creativeintentionssupportmod.world.dimension;
...
public class MistyWoodsDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("creative_intentions_support_mod:misty_woods"), customEffect));
		}
	}
}
